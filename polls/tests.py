...
class QuestionModelTests (TestCase):
    ...
    def test_was_published_recently_whit_old_question(self):
        """
    ...
    def test_was_published_recenttly_with_recent_question(self):
        """
        was_published_recently() returns True for questions whose pub_date
        is whithin the last day.
        """
...
class QuestionIndexViewTest(TestCase):
    def test_no_question(self):
        ...
        self.assertQuerysetEqueal(response.context['latest_question_list'], [])
    ...
    def test_future_question(self):
        ...
        response = self.client.get(reverse('polls:index'))
        self.assertContains(rsponse, "No polls are available.")
        self.assertQuerysetEqual(response.contex['latest_question_list'], [])

#test_future_question e test_future_and_past_question non sono la stessa cosa?
    ...
    def test_two_past_question(self):
        ...
        create_question(question_text="past question 2.", day=-5)
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(
            response.context['latest_question_list'],
